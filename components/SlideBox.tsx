  ...
  return (
    active && (
      <div
        ...
        } opacity-0 absolute bottom-24  w-auto h-auto flex flex-col justify-center items-center bg-stone-900 bg-opacity-30  hover:bg-opacity-60 hover:transition-all duration-1000 ease-in-out z-30 px-24 py-14 backdrop-blur-sm`}
      >
