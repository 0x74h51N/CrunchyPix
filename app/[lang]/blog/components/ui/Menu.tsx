  ...
  return (
    <>
      <div
        ref={stickyRef}
        className={clsx(
          'sticky flex items-center justify-end border border-base-300 backdrop-blur-sm backdrop-filter bg-base-100 top-0 rigth-0 md:p-2 !select-none z-50 self-end transition-all ease-in-out duration-500',
          open
            ? 'w-full md:pl-6 h-[58px] bg-opacity-25'
            : 'md:-mr-8 sm:-mr-5 -mr-3 md:w-16 w-12 h-22 bg-opacity-100',
        )}
      >
        {open && (
          <div
